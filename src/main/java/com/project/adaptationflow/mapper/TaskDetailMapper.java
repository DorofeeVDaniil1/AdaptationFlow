...
@Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE, componentModel = MappingConstants.ComponentModel.SPRING,
        uses = {TaskDetailAdditionalInfoMapper.class})
public interface TaskDetailMapper {
    ...
    default void linkTaskDetailAdditionalInfos(@MappingTarget TaskDetail taskDetail) {
        taskDetail.getTaskDetailAdditionalInfos().
                forEach(taskDetailAdditionalInfo -> taskDetailAdditionalInfo.setTaskDetail(taskDetail));
    }
